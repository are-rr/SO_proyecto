...
int main(){
    ...
    while (ejecutando){
        ...
        if (strcmp(comando, "Salir") == 0){
            ...
            imprimirlista(lista_listos, y_procesosListos);
            ...
            imprimirlista(lista_ejecucion, y_procesoEjecucion);
...
void imprimirEstado(struct Nodo *listos,struct Nodo *ejecucion,struct Nodo *terminados) {
    ...
    mvprintw(8, 0, "=== EJECUCION ===");
    imprimirlista(ejecucion, 9);

    mvprintw(12, 0, "=== LISTOS ===");
    imprimirlista(listos, 13);

    mvprintw(17, 0, "=== TERMINADOS ===");
    imprimirlista(terminados, 18);

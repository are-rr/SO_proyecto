//codigo que tenia antes, pero sin el cambio en el errores de matar ->mensajes
#include <stdio.h>
#include <string.h>
#include <ctype.h>
#include <stdlib.h>
...
struct Nodo {
    ...
    FILE* Archivo;//nombre del archivo //Guardar el puntero al archivo FILE *, con eso ya no tendriamos que saltarnos los renglones 
